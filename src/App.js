...
export default function App() {
  return (
    <div>
      ...
      <ArtistCard
        name={artistData.names[0]}
        image={artistData.images[0]}
        famousSong={artistData.famousSongs[0]}
      />
      <ArtistCard
        name={artistData.names[1]}
        image={artistData.images[1]}
        famousSong={artistData.famousSongs[1]}
      />
      <ArtistCard
        name={artistData.names[2]}
        image={artistData.images[2]}
        famousSong={artistData.famousSongs[2]}
      />
    </div>
  );
}
